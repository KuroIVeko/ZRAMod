...
cmd_apply() {
  ...
  ENABLED=""; ZRAM_ALGO=""; ZRAM_SIZE_BYTES=""; ZRAM_PRIORITY=""; VM_SWAPPINESS=""; VM_WATERMARK_SCALE_FACTOR=""
  . "$CONF"
  log "读取到配置: ENABLED=$ENABLED ZRAM_ALGO=$ZRAM_ALGO ZRAM_SIZE_BYTES=$ZRAM_SIZE_BYTES ZRAM_PRIORITY=$ZRAM_PRIORITY VM_SWAPPINESS=$VM_SWAPPINESS VM_WATERMARK_SCALE_FACTOR=$VM_WATERMARK_SCALE_FACTOR"
